...
var Animate = /** @class */ (function (_super) {
    ...
    Animate.prototype.render = function () {
        ...
        return react_1.default.Children.map(children, function (item) { return react_1.default.cloneElement(item, {
            style: __assign({
...
var AnimateQueue = /** @class */ (function (_super) {
    ...
    function AnimateQueue() {
        ...
        _this.handleAnimate = function (animate) {
            var _a = _this.props, _b = _a.interval, interval = _b === void 0 ? defaultInterval : _b, children = _a.children, _c = _a.speed, speed = _c === void 0 ? defaultSpeed : _c;
    ...
    AnimateQueue.prototype.componentWillReceiveProps = function (nextProps) {
    ...
    AnimateQueue.prototype.render = function () {
        ...
        return react_1.default.Children.map(children, function (item, index) {
            return react_1.default.createElement(Animate, __assign({ animate: index < current, speed: speed }, rest), item);
        });
    };
    return AnimateQueue;
}(react_1.default.Component));
...
var AnimateQueueGroup = /** @class */ (function (_super) {
    ...
    AnimateQueueGroup.prototype.render = function () {
        ...
        var current = this.state.current;
        return react_1.default.Children.map(children, function (item, index) {
            return (react_1.default.createElement("div", { className: "ze-animate-group-wrapper" }, react_1.default.cloneElement(item, __assign({ animate: index < current }, rest, { onAnimateEnd: _this.handleNextAnimate }))));
        });
    };
