...
var InputArea = /** @class */ (function (_super) {
    ...
    InputArea.prototype.render = function () {
        var _this = this;
        var _a = this.props, label = _a.label, rows = _a.rows, fullWidth = _a.fullWidth, width = _a.width, placeholder = _a.placeholder, rest = __rest(_a, ["label", "rows", "fullWidth", "width", "placeholder"]);
        ...
        return (React.createElement("div", { onClick: function () { return _this.setFocus(); }, style: { width: width }, className: classnames_1.default(fullWidth && 'ze-input-area-full', label && 'ze-input-area-has-label', 'ze-input-area') },
            React.createElement("div", { className: 'ze-input-wrapper' + (focus ? ' ze-focus' : '') },
                ...
                React.createElement("textarea", __assign({ placeholder: placeholder, ref: this.$input, className: "ze-input", onFocus: this.handleFocus, onBlur: this.handleBlur, onChange: this.handleChange }, rest)))));
    };
    return InputArea;
}(React.Component));
