...
var MusicPlayer = /** @class */ (function (_super) {
    ...
    function MusicPlayer() {
        ...
        _this.$listInner = React.createRef();
    ...
    MusicPlayer.prototype.render = function () {
        ...
        var audio = this.$audio.current || {};
        return (React.createElement("div", { className: classnames_1.default("main-music-player", open ? 'open' : 'close', hiddenInBottom ? 'hidden' : 'show', showList && 'main-music-player-show-list', audioConfig.position === 'bottom' && 'main-music-player-in-bottom', audioConfig.size === 'large' && 'main-music-player-large', paused ? 'pause' : 'play') },
            React.createElement("audio", { src: url, ref: this.$audio, onEnded: this.handleNext }),
            React.createElement("div", { className: "main-music-player-wrapper" },
                React.createElement("div", { className: "main-music-player-pic", onClick: paused ? this.handlePlay : this.handlePause },
                    React.createElement("img", { src: pic }),
                    React.createElement("div", { className: classnames_1.default("music-player-play-btn", paused ? 'pause' : 'play') },
                        React.createElement("svg", { width: 30, height: 30 },
                            React.createElement("path", { className: "svg-play-btn", stroke: "#fff", strokeWidth: 3, strokeLinecap: "butt", fill: "none" })))),
                React.createElement("div", { className: "main-music-player-info" },
                    React.createElement("div", { style: { width: '100%' } },
                        React.createElement("div", { className: "main-music-player-name text-overflow-ellipsis", style: { width: 'calc(100% - 80px)' } }, name),
                    ...
                    React.createElement("div", { className: "main-music-player-control" },
                        React.createElement("svg", { width: 25, height: 30, onClick: this.handlePrev },
                            React.createElement("path", { className: "svg-play-btn", stroke: "#999", strokeWidth: 3, strokeLinecap: "round", fill: "none", d: "M18 3 5 15 18 27" })),
                        React.createElement("svg", { width: 25, height: 30, onClick: this.handleNext },
                            React.createElement("path", { className: "svg-paly-btn", stroke: "#999", strokeWidth: 3, strokeLinecap: "round", fill: "none", d: "M3 3 18 15 3 27" }))),
                    currentTime
                        ? React.createElement("div", { className: "main-music-player-progress-bar", onClick: this.handlePlayFrom },
                            ...
                            React.createElement("span", { className: "main-music-player-progress-bar-timer" },
                                secondToMunite(audio.currentTime),
                                " / ",
                                secondToMunite(audio.duration)),
                            this.lyric
                                ? React.createElement("span", { className: "main-music-player-progress-bar-lyric text-overflow-ellipsis", style: { width: 'calc(100% - 80px)' } }, this.lyric)
                                : null)
                        : null),
                React.createElement("div", { className: classnames_1.default("main-music-player-toggle", open ? 'open' : 'close'), onClick: this.handleToggleOpen },
                    React.createElement("svg", { width: 10, height: 30 },
                        React.createElement("path", { className: "svg-btn", stroke: "#fff", strokeWidth: 2, strokeLinecap: "butt", fill: "none" })))),
            React.createElement("div", { className: "main-music-player-sider" },
                React.createElement("div", { className: "main-music-player-sider-ball", onClick: this.handleToggleList }, "\u5217\u8868"),
                React.createElement("div", { className: "main-music-player-sider-ball", onClick: this.handleTogglePanel }, "\u6536\u8D77")),
            React.createElement("div", { className: "main-music-player-list", ref: this.$list },
                React.createElement("div", { className: "main-music-player-list-inner", ref: this.$listInner },
                    React.createElement("h3", null,
                        ...
                        React.createElement("span", { className: "sub" },
                            ...
                            musics.length,
                            "\u9996")),
                    React.createElement("div", { className: "main-music-player-list-wrapper" }, musics.map(function (music, index) { return (React.createElement("div", { key: music.id, className: "main-music-player-list-item", onClick: function () { return _this.handleToggle(index); } },
