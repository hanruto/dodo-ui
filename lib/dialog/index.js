...
var Dialog = /** @class */ (function (_super) {
    ...
    Dialog.prototype.render = function () {
        var _a = this.props, children = _a.children, title = _a.title, visible = _a.visible, onCancel = _a.onCancel, onOk = _a.onOk, noCancelBtn = _a.noCancelBtn, _b = _a.animationDuration, animationDuration = _b === void 0 ? defaulAnimationDuration : _b;
        return (React.createElement("div", { style: { animationDuration: animationDuration / 1000 + 's' }, className: classnames_1.default('do-dialog', visible ? 'do-dialog-animate-in' : 'do-dialog-animate-out') },
            ...
            React.createElement("div", { className: "do-dialog-footer" },
                !noCancelBtn && React.createElement(button_1.default, { onClick: onCancel }, "\u53D6\u6D88"),
...
var create = function (option) {
    ...
    var close = function (option) {
        ...
        return new Promise(function (resolve) {
            ReactDOM.render(React.createElement(Dialog, __assign({}, props, { visible: false })), tool_1.getDOMById(dialogRootId));
            !option.notCloseMask && mask_1.default.hidden();
            setTimeout(function () {
    ...
    var show = function () {
        return new Promise(function (resolve) {
            mask_1.default.show();
            ReactDOM.render(React.createElement(Dialog, __assign({}, props, { visible: true, onCancel: function () { return resolve(); }, onOk: function () { return resolve(true); } })), tool_1.getDOMById(dialogRootId));
        });
    };
